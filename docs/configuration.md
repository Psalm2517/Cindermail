...
|---|---|---|---|
| `DISPOSABLE_DOMAIN` | no | required, no default | The domain addresses get generated on. |
...
| `ADDRESS_TTL_SECONDS` | no | `604800` (7 days) | How long a new or extended address lives before it expires. |
